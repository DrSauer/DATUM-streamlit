...
over_area_new = st.sidebar.number_input('New overprofile of excavation/spraying area [m^2]', min_value = 0)
section_length = st.sidebar.number_input('New section length [metres]', min_value = 0)
project_duration = st.sidebar.number_input('Estimated project duration [days]', min_value = 0)
